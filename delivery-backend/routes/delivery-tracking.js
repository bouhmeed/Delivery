    ...
    try {
        ...
        const query = `
            ...
            SELECT 
                ...
                t."tripId" as "tripIdentifier",

                l.name as "depotName",

                l.address as "depotAddress",

                l.city as "depotCity",

                l."postalCode" as "depotPostalCode"

            FROM "Trip" t

            LEFT JOIN "Location" l ON t."depotId" = l.id

            WHERE t."driverId" = $1 

            AND DATE(t."tripDate") = $2
        ...
        const deliveriesQuery = `
            ...
            SELECT 
                ...
                origin_loc."postalCode" as "originPostalCode"
        ...
        // Log des détails de chaque livraison pour vérifier les données de l'origine
        deliveries.forEach((delivery, index) => {
            console.log(`📦 Livraison ${index + 1}:`, {
                shipmentId: delivery.shipmentId,
                shipmentNo: delivery.shipmentNo,
                originId: delivery.originId,
