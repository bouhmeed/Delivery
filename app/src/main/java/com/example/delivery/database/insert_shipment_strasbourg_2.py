...
def main():
    ...
    print("\n--- ⚙️ INSERTING SECOND SHIPMENT FOR STRASBOURG ---")
    ...
    INSERT INTO "Shipment" (
        ...
        'SHIP-PIERRE-STRASBOURG-2-20260708',
        {client_id},
        'OUTBOUND',
        {depot_loc_id},
        {dest_loc_id},
    ...
    if res_shipment:
        print(f"✅ Second shipment for Strasbourg inserted successfully!")
        # Get the inserted shipment ID
        get_shipment_id_query = """
            SELECT id FROM "Shipment" 
            WHERE "shipmentNo" = 'SHIP-PIERRE-STRASBOURG-2-20260708' 
