...
def check_defects_table_structure():
    """Check the structure of ShipmentReturnDefects table"""
    ...
    query = """
        ...
        WHERE table_name = 'ShipmentReturnDefects'
        ORDER BY ordinal_position;
    """
    
    print("📋 Structure de la table ShipmentReturnDefects...")
    print("="*80)
    ...
    try:
        ...
        if rows:
            ...
            print("❌ Table ShipmentReturnDefects n'existe pas ou est vide")
            
    except Exception as e:
        print(f"❌ Erreur: {e}")

if __name__ == "__main__":
    check_defects_table_structure()
