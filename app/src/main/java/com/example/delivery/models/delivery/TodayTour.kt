...
data class TodayTourData(
    @SerializedName("hasTour") val hasTour: Boolean,
    @SerializedName("message") val message: String? = null,
    @SerializedName("tour") val tour: TourInfo? = null,
    @SerializedName("statistics") val statistics: TourStatistics? = null,
    @SerializedName("shipments") val shipments: List<Shipment> = emptyList()
)
...
data class TourStatistics(
    ...
    @SerializedName("remainingShipments") val remainingShipments: Int,
    @SerializedName("completionPercentage") val completionPercentage: Int,
    @SerializedName("progressBar") val progressBar: String
)
