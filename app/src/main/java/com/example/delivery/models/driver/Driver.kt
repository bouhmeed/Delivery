...
data class Driver(
    ...
    @SerializedName("contractHoursWeek") val contractHoursWeek: Int?,
    @SerializedName("homeDepotId") val homeDepotId: String?,
    @SerializedName("tenantId") val tenantId: String?,
    @SerializedName("status") val status: String?,
    @SerializedName("address") val address: String?,
    @SerializedName("assignedVehicle") val assignedVehicle: String?,
